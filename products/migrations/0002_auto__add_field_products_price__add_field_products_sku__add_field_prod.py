...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products_products', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0.0),
                      keep_default=False)

        # Adding field 'Products.sku'
        db.add_column(u'products_products', 'sku',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=160),
                      keep_default=False)

        # Adding field 'Products.inventory'
        db.add_column(u'products_products', 'inventory',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'products_products', 'price')

        # Deleting field 'Products.sku'
        db.delete_column(u'products_products', 'sku')

        # Deleting field 'Products.inventory'
        db.delete_column(u'products_products', 'inventory')
    ...
    models = {
        u'products.products': {
            ...
            'sku': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '160'}),
